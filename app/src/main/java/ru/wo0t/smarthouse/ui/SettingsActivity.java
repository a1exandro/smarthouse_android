...
public class SettingsActivity extends PreferenceActivity {
    ...
    private void setupSimplePreferencesScreen() {
        ...
        fakeHeader.setTitle(R.string.pref_header_remote_access);
        getPreferenceScreen().addPreference(fakeHeader);
        addPreferencesFromResource(R.xml.pref_remote_access);
        ...
        bindPreferenceSummaryToValue(findPreference("remote_login"));
        bindPreferenceSummaryToValue(findPreference("remote_password"));
        bindPreferenceSummaryToValue(findPreference("alarm_sound"));
    }
